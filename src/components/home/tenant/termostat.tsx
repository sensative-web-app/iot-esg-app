...
export const Thermostat = ({
  ...
  return (
    <Card className="w-64  rounded-2xl pt-4 bg-muted justify-center">
      <div className="temperature-display-container h-1/2 flex items-center justify-center flex-col">
        <div>Thermostat</div>
        <div className="  text-white text-center text-3xl  transition duration-500">
          {temperatureValue}°C
        </div>
      </div>
      <div className="button-container flex justify-around items-center px-8">
        <button
